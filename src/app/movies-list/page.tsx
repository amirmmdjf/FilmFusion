            ...
            <div className="flex flex-wrap justify-center mt-10">
            {
                movies?.map((movie)=>(
                    <div key={movie.id} className="w-[250px] h-[530px] mx-5 mb-8 flex flex-col items-center shadow-lg rounded-lg relative">
                         <Link href={`/movies-list/${movie.id}`} className="w-full">
                        <img 
                        ...
                        <Link href={`/movies-list/${movie.id}`} className="bg-blue-600 text-white w-[200px] h-10 mt-5 rounded-xl absolute bottom-5 flex justify-center">
